...
function mapDispathch2Props(dispatch, ownProps){
    return {
        onIncrement: () => {
            dispatch(Actions.update(ownProps.caption, 1));
        },
...
export default connect(mapState2Props, mapDispathch2Props)(Counter);